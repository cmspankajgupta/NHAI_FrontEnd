...
const Header = () => {
  ...
  return (
    <div className="DesktopMenu-section">
      <AppBar
        sx={{ backgroundColor: "#ecf0f5", boxShadow: "none", color: "black", position: 'sticky', paddingBottom:'2.5rem' }}
      >
        <Toolbar
          justify="flex-end"
          sx={{
        ...
        >
          <Box display="flex" alignItems="center">
            ...
            <Divider
              ...
              sx={{ height: "20px", mr: 1, width: "4px" }}
            />
            <img src={NHAI} alt="NHAI Logo" style={{ height: "30px" }} />
            <MenuItem className="header-text" sx={{ fontWeight: 600 }}>
